...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[upload] userId:", clerkUserId, "planType:", planType, "quota.fileSizeLimit:", quota.fileSizeLimit);
      ...
      return NextResponse.json(
        {
          ...
          message: `File exceeds maximum size of ${maxMB} MB (plan: ${planType})`,
        },
        { status: 400 }
      );
    }
